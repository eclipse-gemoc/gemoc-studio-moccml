...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Int Sup Equal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.moccml.constraint.fsmkernel.model.FSMModel.editionextension.impl.IntSupEqualImpl#getLeftValue <em>Left Value</em>}</li>
 *   <li>{@link org.eclipse.gemoc.moccml.constraint.fsmkernel.model.FSMModel.editionextension.impl.IntSupEqualImpl#getRightValue <em>Right Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntSupEqualImpl extends BooleanExpressionImpl implements IntSupEqual {
	/**
	...
	protected EClass eStaticClass() {
		return EditionExtensionPackage.Literals.INT_SUP_EQUAL;
	}
	...
	public NotificationChain basicSetLeftValue(IntegerExpression newLeftValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditionExtensionPackage.INT_SUP_EQUAL__LEFT_VALUE, oldLeftValue, newLeftValue);
	...
	public void setLeftValue(IntegerExpression newLeftValue) {
		if (newLeftValue != leftValue) {
			...
			if (leftValue != null)
				msgs = ((InternalEObject)leftValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditionExtensionPackage.INT_SUP_EQUAL__LEFT_VALUE, null, msgs);
			if (newLeftValue != null)
				msgs = ((InternalEObject)newLeftValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditionExtensionPackage.INT_SUP_EQUAL__LEFT_VALUE, null, msgs);
			msgs = basicSetLeftValue(newLeftValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditionExtensionPackage.INT_SUP_EQUAL__LEFT_VALUE, newLeftValue, newLeftValue));
	}
	...
	public NotificationChain basicSetRightValue(IntegerExpression newRightValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditionExtensionPackage.INT_SUP_EQUAL__RIGHT_VALUE, oldRightValue, newRightValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRightValue(IntegerExpression newRightValue) {
		if (newRightValue != rightValue) {
			NotificationChain msgs = null;
			if (rightValue != null)
				msgs = ((InternalEObject)rightValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditionExtensionPackage.INT_SUP_EQUAL__RIGHT_VALUE, null, msgs);
			if (newRightValue != null)
				msgs = ((InternalEObject)newRightValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditionExtensionPackage.INT_SUP_EQUAL__RIGHT_VALUE, null, msgs);
			msgs = basicSetRightValue(newRightValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EditionExtensionPackage.INT_SUP_EQUAL__RIGHT_VALUE, newRightValue, newRightValue));
	}
