 ...
 * "moccml". If a sample multi-page editor (also available
 * as a template) is registered for the same extension, it will
 * be able to open it.
 */

public class MoCCMLFileNewWizard extends Wizard implements INewWizard {
	private MoCCMLFileNewWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for MoCCMLFileNewWizard.
	 */
	public MoCCMLFileNewWizard() {
		super();
	...
	public void addPages() {
		page = new MoCCMLFileNewWizardPage(selection);
		addPage(page);
	}
	...
	private InputStream openContentStream() {
		String contents =
			"AutomataConstraintLibrary MyCoordination{\n"+ 
