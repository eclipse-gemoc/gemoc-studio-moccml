...
public class NewMoCMLWizard extends Wizard implements INewWizard {
	private NewMoCMLWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewMoCMLWizard.
	 */
	public NewMoCMLWizard() {
		super();
	...
	public void addPages() {
		page = new NewMoCMLWizardPage(selection);
		addPage(page);
	}
