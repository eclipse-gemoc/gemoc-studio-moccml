 ...
 */
package org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.ide.contentassist.antlr.internal.InternalFSMDslParser;
...
public class FSMDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(FSMDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FSMDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTriggerAccess().getGroup_3_3(), "rule__Trigger__Group_3_3__0");
			builder.put(grammarAccess.getTriggerAccess().getGroup_4(), "rule__Trigger__Group_4__0");
			builder.put(grammarAccess.getTriggerAccess().getGroup_4_3(), "rule__Trigger__Group_4_3__0");
			...
			builder.put(grammarAccess.getTransitionAccess().getTriggerAssignment_8_1(), "rule__Transition__TriggerAssignment_8_1");
			builder.put(grammarAccess.getTransitionAccess().getGuardAssignment_9_1(), "rule__Transition__GuardAssignment_9_1");
			...
			builder.put(grammarAccess.getTriggerAccess().getTrueTriggersAssignment_3_2(), "rule__Trigger__TrueTriggersAssignment_3_2");
			builder.put(grammarAccess.getTriggerAccess().getTrueTriggersAssignment_3_3_1(), "rule__Trigger__TrueTriggersAssignment_3_3_1");
			builder.put(grammarAccess.getTriggerAccess().getFalseTriggersAssignment_4_2(), "rule__Trigger__FalseTriggersAssignment_4_2");
			builder.put(grammarAccess.getTriggerAccess().getFalseTriggersAssignment_4_3_1(), "rule__Trigger__FalseTriggersAssignment_4_3_1");
	...
	@Override
	protected InternalFSMDslParser createParser() {
		InternalFSMDslParser result = new InternalFSMDslParser(null);
