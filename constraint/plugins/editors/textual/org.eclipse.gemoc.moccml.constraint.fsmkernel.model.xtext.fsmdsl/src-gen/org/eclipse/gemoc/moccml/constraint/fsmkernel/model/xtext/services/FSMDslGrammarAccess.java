...
public class FSMDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	//    'ExpressionDeclaration' name=ID '(' parameters+=AbstractEntity ( "," parameters+=AbstractEntity)* ')' ':' returnType=[BasicType::Type|EString];
	...
	//    '{'
	//        ('root' '=' rootExpression=[ClockExpressionAndRelation::Expression|EString]
	//        ( concreteEntities+=ConcreteEntity |
	...
	//        ((concreteEntities+=ConcreteEntity |
	//        ( classicalExpressions+=ClassicalExpression0))* &
	//        ('switch' '{' exprCases+=ExprCase ( exprCases+=ExprCase)* '}'
	...
	//        (((concreteEntities+=ConcreteEntity) |
	//        (classicalExpressions+=ClassicalExpression0 ))* &
	//        ('switch' '{' relCases+=RelCase ( relCases+=RelCase)* '}'
	...
	//    Clock | StringElement | BooleanElement | IntegerElement | RealElement| RecordElement | SequenceElement;
	...
	//    Death | UpTo | Union | Intersection | Inf | Sup | Concatenation | StrictSampling | NonStrictSampling | Defer | Discretization | Wait;
	...
	//    receive="receive"|
	//    send="send"|
	//    undefined="any"|undefined="all"|undefined="undefined"
	//;
	...
	//terminal Real0 returns ecore::EFloat: ('0'..'9')+'.'('0'..'9')+;
	...
	//    'Sequence' (name=ID)? (':' type=[BasicType::Type|EString])? '='
	...
	//    'SequenceType' name=ID":"elementType=[BasicType::PrimitiveType|ID];
