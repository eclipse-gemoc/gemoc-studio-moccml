			...
			(
				...
				lv_name_2_0=ruleEString
				{
					...
					set(
						...
						"name",
						lv_name_2_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.EString");
				...
				(
					...
					lv_imports_4_0=ruleImportStatement
					{
						...
						add(
							...
							"imports",
							lv_imports_4_0,
							"org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.ImportStatement");
						afterParserOrEnumRuleCall();
					}
				)
			)*
					...
					(
						...
						lv_expressionLibraries_5_0=ruleExpressionLibrary
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.ExpressionLibrary");
							afterParserOrEnumRuleCall();
						}
					)
				)
					...
					(
						...
						lv_relationLibraries_6_0=ruleRelationLibrary
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.RelationLibrary");
							afterParserOrEnumRuleCall();
						}
					)
				)
					...
					(
						...
						lv_predefinedTypes_7_0=ruleType
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Type");
							afterParserOrEnumRuleCall();
						}
					)
				)
			...
			(
				...
				lv_declarationBlock_7_0=ruleDeclarationBlock
				{
					...
					set(
						...
						"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.DeclarationBlock");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_transitions_17_0=ruleTransition
					{
						...
						add(
							...
							"transitions",
							lv_transitions_17_0,
							"org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Transition");
						afterParserOrEnumRuleCall();
					}
				)
			)
						...
						(
							...
							lv_trigger_10_0=ruleTrigger
							{
								...
								set(
									...
									"trigger",
									lv_trigger_10_0,
									"org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Trigger");
								afterParserOrEnumRuleCall();
							}
						)
					)
						...
						(
							...
							lv_guard_12_0=ruleGuard
							{
								...
								set(
									...
									"guard",
									lv_guard_12_0,
									"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.Guard");
								afterParserOrEnumRuleCall();
							}
						)
					)
				...
				(
					...
					lv_actions_18_0=ruleAction
					{
						...
						add(
							...
							"actions",
							lv_actions_18_0,
							"org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Action");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_actions_4_0=ruleIntegerAssignement
				{
					...
					add(
						...
						"actions",
						lv_actions_4_0,
						"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.IntegerAssignement");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_leftValue_4_0=ruleIntegerRef
				{
					...
					set(
						...
						"leftValue",
						lv_leftValue_4_0,
						"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.IntegerRef");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_rightValue_6_0=ruleIntegerExpression
				{
					...
					set(
						...
						"rightValue",
						lv_rightValue_6_0,
						"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.IntegerExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_operand_6_0=ruleSeqExpression
				{
					...
					set(
						...
						"operand",
						lv_operand_6_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.SeqExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_elements_3_0=ruleElement
					{
						...
						add(
							...
							"elements",
							lv_elements_3_0,
							"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Element");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_expressionDeclarations_4_1=ruleExpressionDeclaration
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.ExpressionDeclaration");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_expressionDeclarations_4_2=rulekernelExpressionDecl
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.kernelExpressionDecl");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_expressionDefinitions_5_0=ruleExpressionDefinition
					{
						...
						add(
							...
							"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.ExpressionDefinition");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_relationDeclarations_4_1=ruleRelationDeclaration
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.RelationDeclaration");
							afterParserOrEnumRuleCall();
						}
						    |
						{
						...
						lv_relationDeclarations_4_2=rulekernelRelationDecl
						{
							...
							add(
								...
								"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.kernelRelationDecl");
							afterParserOrEnumRuleCall();
						}
					)
				)
				...
				(
					...
					lv_relationDefinitions_5_0=ruleRelationDefinition
					{
						...
						add(
							...
							"org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.RelationDefinition");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_parameters_3_0=ruleAbstractEntity
				{
					...
					add(
						...
						"parameters",
						lv_parameters_3_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.AbstractEntity");
					afterParserOrEnumRuleCall();
				}
			)
		)
					...
					(
						...
						lv_classicalExpressions_10_0=ruleClassicalExpression0
						{
							...
							add(
								...
								"org.eclipse.gemoc.moccml.constraint.fsmkernel.model.xtext.FSMDsl.ClassicalExpression0");
							afterParserOrEnumRuleCall();
						}
					)
				)
...
entryRuleConditionalExpressionDefinition returns [EObject current=null]@init {
									...
									(
										...
										lv_exprCases_11_0=ruleExprCase
										{
											...
											add(
												...
												"exprCases",
												lv_exprCases_11_0,
												"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.ExprCase");
											afterParserOrEnumRuleCall();
										}
									)
								)
										...
										(
											...
											lv_defaultExpression_15_0=ruleExpression
											{
												...
												set(
													...
													"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Expression");
												afterParserOrEnumRuleCall();
											}
										)
									)
...
entryRuleConditionalRelationDefinition returns [EObject current=null]@init {
	UnorderedGroupState myUnorderedGroupState = getUnorderedGroupHelper().snapShot(
									...
									(
										...
										lv_relCases_11_0=ruleRelCase
										{
											...
											add(
												...
												"relCases",
												lv_relCases_11_0,
												"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.RelCase");
											afterParserOrEnumRuleCall();
										}
									)
								)
									...
									(
										...
										lv_defaultRelation_15_0=ruleRelation
										{
											...
											add(
												...
												"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Relation");
											afterParserOrEnumRuleCall();
										}
									)
								)*
				...
				(
					...
					lv_bindings_7_0=ruleBinding
					{
						...
						add(
							...
							"bindings",
							lv_bindings_7_0,
							"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Binding");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_desiredEventKind_3_0=ruleEventKind
				{
					...
					set(
						...
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.EventKind");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_operand_7_0=ruleRealExpression
				{
					...
					set(
						...
						"operand",
						lv_operand_7_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.RealExpression");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"value",
						lv_value_5_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Real0");
				}
			)
		)
	)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"value",
							lv_value_5_0,
							"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.INT");
					}
				)
			)
		)
			...
			(
				...
				lv_value_6_0=ruleBoolean0
				{
					...
					set(
						...
						"value",
						lv_value_6_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Boolean0");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_finitePart_6_0=rulePrimitiveElement
					{
						...
						add(
							...
							"finitePart",
							lv_finitePart_6_0,
							"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.PrimitiveElement");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_box_8_0=ruleBox
				{
					...
					add(
						...
						"box",
						lv_box_8_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Box");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_field_3_0=ruleField
				{
					...
					add(
						...
						"field",
						lv_field_3_0,
						"fr.inria.aoste.timesquare.ccslkernel.library.xtext.CCSLLibrary.Field");
					afterParserOrEnumRuleCall();
				}
			)
		)
