 ...
 * generated by Xtext
 */
package org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.services;
...
public class MoCDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StateRelationBasedLibraryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.StateRelationBasedLibrary");
		...
		//StateRelationBasedLibrary ccslmoc::StateRelationBasedLibrary:
	...
	public class ImportStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.ImportStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RelationDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.RelationDefinition");
	...
	public class CCSLStateMachineRelationDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.CCSLStateMachineRelationDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//CCSLStateMachineRelationDefinition ccslmoc::StateMachineRelationDefinition:
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	{fsmmodel::Transition}
		//	'from' source=[fsmmodel::State] 'to' target=[fsmmodel::State] ':' (name=EString '->')? '(' (('when' trigger=Trigger)
		//	('if' guard=Guard)? | ('if' guard=Guard) ('when' trigger=Trigger)?)? ('do' actions+=Action)*
		//	')';
		@Override public ParserRule getRule() { return rule; }
	...
	public class TriggerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Trigger");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.Action");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FinishClockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.FinishClock");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//FinishClock ccslmoc::FinishClock:
		//	{ccslmoc::FinishClock}
	...
	public class StartClockElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl.StartClock");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.gemoc.moccml.constraint.ccslmocc.model.xtext.MoCDsl".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	declarationBlock=DeclarationBlock? ('init' ':' initialStates+=[fsmmodel::State|EString]) (","
	//	initialStates+=[fsmmodel::State|EString])* ('finals' ':' finalStates+=[fsmmodel::State|EString] (","
	//	finalStates+=[fsmmodel::State|EString])*)? (states+=State | transitions+=super::Transition)+
	//	'}';
	...
	//	'Library' name=ID
	//	'{' (('imports' '{' imports+=super::ImportStatement* '}')? (expressionLibraries+=ExpressionLibrary |
	...
	//	relationDefinitions+=super::RelationDefinition)+
	//	'}';
