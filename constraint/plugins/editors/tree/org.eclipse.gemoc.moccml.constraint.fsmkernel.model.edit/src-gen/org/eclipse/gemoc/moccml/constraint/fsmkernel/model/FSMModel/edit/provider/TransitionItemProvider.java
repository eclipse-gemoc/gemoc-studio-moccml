...
/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.moccml.constraint.fsmkernel.model.FSMModel.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FSMModelPackage.Literals.TRANSITION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FSMModelPackage.Literals.TRANSITION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FSMModelPackage.Literals.TRANSITION__GUARD);
			childrenFeatures.add(FSMModelPackage.Literals.TRANSITION__TRIGGER);
			childrenFeatures.add(FSMModelPackage.Literals.TRANSITION__ACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FSMModelPackage.Literals.TRANSITION__GUARD,
				 FSMModelFactory.eINSTANCE.createGuard()));

		newChildDescriptors.add
			(createChildParameter
				(FSMModelPackage.Literals.TRANSITION__TRIGGER,
				 FSMModelFactory.eINSTANCE.createTrigger()));
