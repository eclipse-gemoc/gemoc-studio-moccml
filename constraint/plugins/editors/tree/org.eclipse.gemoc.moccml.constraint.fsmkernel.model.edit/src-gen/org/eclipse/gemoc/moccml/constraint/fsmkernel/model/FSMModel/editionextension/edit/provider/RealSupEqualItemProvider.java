...
import org.eclipse.gemoc.moccml.constraint.fsmkernel.model.FSMModel.editionextension.RealSupEqual;

/**
 * This is the item provider adapter for a {@link org.eclipse.gemoc.moccml.constraint.fsmkernel.model.FSMModel.editionextension.RealSupEqual} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RealSupEqualItemProvider
	 ...
	 * @generated
	 */
	public RealSupEqualItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EditionExtensionPackage.Literals.REAL_SUP_EQUAL__LEFT_VALUE);
			childrenFeatures.add(EditionExtensionPackage.Literals.REAL_SUP_EQUAL__RIGHT_VALUE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RealSupEqual"));
	}
	...
	public String getText(Object object) {
		String label = ((RealSupEqual)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RealSupEqual_type") :
			getString("_UI_RealSupEqual_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RealSupEqual.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EditionExtensionPackage.Literals.REAL_SUP_EQUAL__LEFT_VALUE,
		...
		newChildDescriptors.add
			(createChildParameter
				(EditionExtensionPackage.Literals.REAL_SUP_EQUAL__RIGHT_VALUE,
				 EditionExtensionFactory.eINSTANCE.createRealSelfPlusAssignement()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == EditionExtensionPackage.Literals.REAL_SUP_EQUAL__LEFT_VALUE ||
			childFeature == EditionExtensionPackage.Literals.REAL_SUP_EQUAL__RIGHT_VALUE;
