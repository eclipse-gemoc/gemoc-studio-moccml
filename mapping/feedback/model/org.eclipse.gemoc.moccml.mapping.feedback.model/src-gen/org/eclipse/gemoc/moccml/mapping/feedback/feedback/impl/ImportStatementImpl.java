 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.moccml.mapping.feedback.feedback.impl.ImportStatementImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportStatementImpl extends MinimalEObjectImpl.Container implements ImportStatement {
	...
	protected EClass eStaticClass() {
		return FeedbackPackage.Literals.IMPORT_STATEMENT;
	}
	...
	public void setImportURI(String newImportURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeedbackPackage.IMPORT_STATEMENT__IMPORT_URI, oldImportURI, importURI));
	}
