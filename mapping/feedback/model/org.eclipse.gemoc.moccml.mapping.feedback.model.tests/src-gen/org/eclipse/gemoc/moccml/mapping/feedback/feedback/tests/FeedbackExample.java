...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>feedback</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FeedbackExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FeedbackPackage.eNS_URI, 
			 FeedbackPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.feedback"));
				When root = FeedbackFactory.eINSTANCE.createWhen();
