 ...
 * @generated
 */
public class AcceleoLauncherForEclToQvto extends AbstractAcceleoGenerator {
    /**
     ...
     * @generated
     */
    public AcceleoLauncherForEclToQvto() {
     ...
     * @generated
     */
    public AcceleoLauncherForEclToQvto(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public AcceleoLauncherForEclToQvto(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                AcceleoLauncherForEclToQvto generator = new AcceleoLauncherForEclToQvto(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(MoCCMLmappingPackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
            resourceSet.getPackageRegistry().put(MoCCMLmappingPackage.eNS_URI, MoCCMLmappingPackage.eINSTANCE);
        }
    }
