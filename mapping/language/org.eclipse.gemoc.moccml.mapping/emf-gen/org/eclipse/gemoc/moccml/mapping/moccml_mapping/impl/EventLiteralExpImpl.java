...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Event Literal Exp</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gemoc.moccml.mapping.moccml_mapping.impl.EventLiteralExpImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventLiteralExpImpl extends LiteralExpCSImpl implements EventLiteralExp {
	...
	protected EClass eStaticClass() {
		return MoCCMLmappingPackage.Literals.EVENT_LITERAL_EXP;
	}
	 ...
	 * @generated
	 */
	public void setValue(EventKind newValue) {
		EventKind oldValue = value;
		value = newValue == null ? VALUE_EDEFAULT : newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MoCCMLmappingPackage.EVENT_LITERAL_EXP__VALUE,
					oldValue, value));
	}
	...
	public <R> R accept(final BaseCSVisitor<R> visitor) {
		return (R) visitor.getAdapter(ECLVisitor.class).visitEventLiteralExp(this);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MoCCMLmappingPackage.EVENT_LITERAL_EXP__VALUE:
			return getValue();
		}
