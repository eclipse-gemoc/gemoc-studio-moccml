...
public abstract class AbstractEclSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ECLExpression_ExpressionKeyword_1_q;
	protected AbstractElementAlias match_ECLRelation_RelationKeyword_1_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ECLExpression_ExpressionKeyword_1_q = new TokenAlias(false, true, grammarAccess.getECLExpressionAccess().getExpressionKeyword_1());
		match_ECLRelation_RelationKeyword_1_q = new TokenAlias(false, true, grammarAccess.getECLRelationAccess().getRelationKeyword_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_ECLExpression_ExpressionKeyword_1_q.equals(syntax))
				emit_ECLExpression_ExpressionKeyword_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_ECLRelation_RelationKeyword_1_q.equals(syntax))
				emit_ECLRelation_RelationKeyword_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_ECLExpression_ExpressionKeyword_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 */
	protected void emit_ECLRelation_RelationKeyword_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
