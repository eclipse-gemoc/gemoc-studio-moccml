...
public class EclGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TimebaseElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cBaseUnitAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cBaseUnitStringLiteralParserRuleCall_2_1_0 = (RuleCall)cBaseUnitAssignment_2_1.eContents().get(0);
		private final Keyword cRightSquareBracketKeyword_2_2 = (Keyword)cGroup_2.eContents().get(2);
		
		//Timebase MoCCMLMappingTimeBase:
		//	{MoCCMLMappingTimeBase}
		//	'TimeBase' ('[' baseUnit=StringLiteral ']')?;
		@Override public ParserRule getRule() { return rule; }

		//{MoCCMLMappingTimeBase} 'TimeBase' ('[' baseUnit=StringLiteral ']')?
		public Group getGroup() { return cGroup; }
		...
		//baseUnit=StringLiteral
		public Assignment getBaseUnitAssignment_2_1() { return cBaseUnitAssignment_2_1; }

		//StringLiteral
		public RuleCall getBaseUnitStringLiteralParserRuleCall_2_1_0() { return cBaseUnitStringLiteralParserRuleCall_2_1_0; }
	...
	public class ClassifierContextDeclCSElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.gemoc.moccml.mapping.xtext.Ecl.ClassifierContextDeclCS");
		private final Group cGroup = (Group)rule.eContents().get(1);
