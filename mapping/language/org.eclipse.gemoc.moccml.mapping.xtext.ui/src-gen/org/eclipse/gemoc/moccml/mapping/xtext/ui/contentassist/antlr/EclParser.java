 ...
 * generated by Xtext
 */
package org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr;
...
public class EclParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr.internal.InternalEclParser createParser() {
		org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr.internal.InternalEclParser result = new org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr.internal.InternalEclParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getAlternatives_3(), "rule__MoCCMLMappingDocument__Alternatives_3");
					...
					put(grammarAccess.getExpCSAccess().getAlternatives_3(), "rule__ExpCS__Alternatives_3");
					put(grammarAccess.getDefCSAccess().getAlternatives(), "rule__DefCS__Alternatives");
					put(grammarAccess.getCasesRuleAccess().getAlternatives_4_0(), "rule__CasesRule__Alternatives_4_0");
					...
					put(grammarAccess.getFeedBackKindAccess().getAlternatives(), "rule__FeedBackKind__Alternatives");
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getGroup(), "rule__MoCCMLMappingDocument__Group__0");
					...
					put(grammarAccess.getTimebaseAccess().getGroup_2(), "rule__Timebase__Group_2__0");
					put(grammarAccess.getBlockTypeAccess().getGroup(), "rule__BlockType__Group__0");
					put(grammarAccess.getExpCSAccess().getGroup_3_0(), "rule__ExpCS__Group_3_0__0");
					put(grammarAccess.getExpCSAccess().getGroup_3_0_1(), "rule__ExpCS__Group_3_0_1__0");
					put(grammarAccess.getMoCCMLMappingPriorityAccess().getGroup(), "rule__MoCCMLMappingPriority__Group__0");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getGroup(), "rule__MoCCMLMappingBlockDefCS__Group__0");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getGroup_2(), "rule__MoCCMLMappingBlockDefCS__Group_2__0");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getGroup_9(), "rule__MoCCMLMappingBlockDefCS__Group_9__0");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getGroup_10(), "rule__MoCCMLMappingBlockDefCS__Group_10__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup(), "rule__MoCCMLMappingEventDefCS__Group__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup_2(), "rule__MoCCMLMappingEventDefCS__Group_2__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup_9(), "rule__MoCCMLMappingEventDefCS__Group_9__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup_9_0(), "rule__MoCCMLMappingEventDefCS__Group_9_0__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup_9_1(), "rule__MoCCMLMappingEventDefCS__Group_9_1__0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getGroup_9_2(), "rule__MoCCMLMappingEventDefCS__Group_9_2__0");
					put(grammarAccess.getCasesRuleAccess().getGroup(), "rule__CasesRule__Group__0");
					put(grammarAccess.getCasesRuleAccess().getGroup_4(), "rule__CasesRule__Group_4__0");
					...
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getOwnedImportsAssignment_1(), "rule__MoCCMLMappingDocument__OwnedImportsAssignment_1");
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getImportsAssignment_2(), "rule__MoCCMLMappingDocument__ImportsAssignment_2");
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getOwnedPackagesAssignment_3_0(), "rule__MoCCMLMappingDocument__OwnedPackagesAssignment_3_0");
					put(grammarAccess.getMoCCMLMappingDocumentAccess().getOwnedContextsAssignment_3_1(), "rule__MoCCMLMappingDocument__OwnedContextsAssignment_3_1");
					...
					put(grammarAccess.getEventTypeAccess().getReferedElementAssignment_2_1(), "rule__EventType__ReferedElementAssignment_2_1");
					put(grammarAccess.getTimebaseAccess().getTimeBaseAssignment_2_1(), "rule__Timebase__TimeBaseAssignment_2_1");
					put(grammarAccess.getExpCSAccess().getNameAssignment_3_0_1_1(), "rule__ExpCS__NameAssignment_3_0_1_1");
					put(grammarAccess.getExpCSAccess().getOwnedRightAssignment_3_0_1_2(), "rule__ExpCS__OwnedRightAssignment_3_0_1_2");
					put(grammarAccess.getMoCCMLMappingPriorityAccess().getHigherAssignment_3(), "rule__MoCCMLMappingPriority__HigherAssignment_3");
					put(grammarAccess.getMoCCMLMappingPriorityAccess().getLowerAssignment_6(), "rule__MoCCMLMappingPriority__LowerAssignment_6");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getVisibilityAssignment_0(), "rule__MoCCMLMappingBlockDefCS__VisibilityAssignment_0");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getConditionAssignment_2_1(), "rule__MoCCMLMappingBlockDefCS__ConditionAssignment_2_1");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getNameAssignment_4(), "rule__MoCCMLMappingBlockDefCS__NameAssignment_4");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getOwnedTypeAssignment_6(), "rule__MoCCMLMappingBlockDefCS__OwnedTypeAssignment_6");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getOwnedSpecificationAssignment_8(), "rule__MoCCMLMappingBlockDefCS__OwnedSpecificationAssignment_8");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getEnterWhenAssignment_9_2(), "rule__MoCCMLMappingBlockDefCS__EnterWhenAssignment_9_2");
					put(grammarAccess.getMoCCMLMappingBlockDefCSAccess().getLeaveWhenAssignment_10_2(), "rule__MoCCMLMappingBlockDefCS__LeaveWhenAssignment_10_2");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getVisibilityAssignment_0(), "rule__MoCCMLMappingEventDefCS__VisibilityAssignment_0");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getConditionAssignment_2_1(), "rule__MoCCMLMappingEventDefCS__ConditionAssignment_2_1");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getNameAssignment_4(), "rule__MoCCMLMappingEventDefCS__NameAssignment_4");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getOwnedTypeAssignment_6(), "rule__MoCCMLMappingEventDefCS__OwnedTypeAssignment_6");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getOwnedSpecificationAssignment_8(), "rule__MoCCMLMappingEventDefCS__OwnedSpecificationAssignment_8");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getDsaResultNameAssignment_9_0_1(), "rule__MoCCMLMappingEventDefCS__DsaResultNameAssignment_9_0_1");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getFutureAssignment_9_1_2(), "rule__MoCCMLMappingEventDefCS__FutureAssignment_9_1_2");
					put(grammarAccess.getMoCCMLMappingEventDefCSAccess().getFeedbackAssignment_9_2_1(), "rule__MoCCMLMappingEventDefCS__FeedbackAssignment_9_2_1");
					put(grammarAccess.getDSAFeedBackRuleAccess().getCasesAssignment(), "rule__DSAFeedBackRule__CasesAssignment");
					put(grammarAccess.getCasesRuleAccess().getConditionAssignment_1(), "rule__CasesRule__ConditionAssignment_1");
					put(grammarAccess.getCasesRuleAccess().getKindOfFeedbackAssignment_2(), "rule__CasesRule__KindOfFeedbackAssignment_2");
					put(grammarAccess.getCasesRuleAccess().getEventToForceAssignment_3(), "rule__CasesRule__EventToForceAssignment_3");
					put(grammarAccess.getCasesRuleAccess().getOnAssignment_4_1(), "rule__CasesRule__OnAssignment_4_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr.internal.InternalEclParser typedParser = (org.eclipse.gemoc.moccml.mapping.xtext.ui.contentassist.antlr.internal.InternalEclParser) parser;
			typedParser.entryRuleMoCCMLMappingDocument();
