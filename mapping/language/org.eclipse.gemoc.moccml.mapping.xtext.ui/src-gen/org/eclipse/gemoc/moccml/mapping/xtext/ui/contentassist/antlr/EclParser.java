...
public class EclParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getECLDocumentAccess().getAlternatives_3(), "rule__ECLDocument__Alternatives_3");
					...
					put(grammarAccess.getECLDocumentAccess().getGroup(), "rule__ECLDocument__Group__0");
					...
					put(grammarAccess.getECLBlockDefCSAccess().getGroup(), "rule__ECLBlockDefCS__Group__0");
					put(grammarAccess.getECLBlockDefCSAccess().getGroup_2(), "rule__ECLBlockDefCS__Group_2__0");
					put(grammarAccess.getECLBlockDefCSAccess().getGroup_9(), "rule__ECLBlockDefCS__Group_9__0");
					put(grammarAccess.getECLBlockDefCSAccess().getGroup_10(), "rule__ECLBlockDefCS__Group_10__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup(), "rule__ECLEventDefCS__Group__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup_2(), "rule__ECLEventDefCS__Group_2__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup_9(), "rule__ECLEventDefCS__Group_9__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup_9_0(), "rule__ECLEventDefCS__Group_9_0__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup_9_1(), "rule__ECLEventDefCS__Group_9_1__0");
					put(grammarAccess.getECLEventDefCSAccess().getGroup_9_2(), "rule__ECLEventDefCS__Group_9_2__0");
					...
					put(grammarAccess.getECLExpressionAccess().getGroup(), "rule__ECLExpression__Group__0");
					put(grammarAccess.getECLExpressionAccess().getGroup_5(), "rule__ECLExpression__Group_5__0");
					put(grammarAccess.getECLRelationAccess().getGroup(), "rule__ECLRelation__Group__0");
					put(grammarAccess.getECLRelationAccess().getGroup_5(), "rule__ECLRelation__Group_5__0");
					...
					put(grammarAccess.getECLDocumentAccess().getOwnedImportsAssignment_1(), "rule__ECLDocument__OwnedImportsAssignment_1");
					put(grammarAccess.getECLDocumentAccess().getImportsAssignment_2(), "rule__ECLDocument__ImportsAssignment_2");
					put(grammarAccess.getECLDocumentAccess().getOwnedPackagesAssignment_3_0(), "rule__ECLDocument__OwnedPackagesAssignment_3_0");
					put(grammarAccess.getECLDocumentAccess().getOwnedContextsAssignment_3_1(), "rule__ECLDocument__OwnedContextsAssignment_3_1");
					...
					put(grammarAccess.getECLBlockDefCSAccess().getVisibilityAssignment_0(), "rule__ECLBlockDefCS__VisibilityAssignment_0");
					put(grammarAccess.getECLBlockDefCSAccess().getConditionAssignment_2_1(), "rule__ECLBlockDefCS__ConditionAssignment_2_1");
					put(grammarAccess.getECLBlockDefCSAccess().getNameAssignment_4(), "rule__ECLBlockDefCS__NameAssignment_4");
					put(grammarAccess.getECLBlockDefCSAccess().getOwnedTypeAssignment_6(), "rule__ECLBlockDefCS__OwnedTypeAssignment_6");
					put(grammarAccess.getECLBlockDefCSAccess().getOwnedSpecificationAssignment_8(), "rule__ECLBlockDefCS__OwnedSpecificationAssignment_8");
					put(grammarAccess.getECLBlockDefCSAccess().getEnterWhenAssignment_9_2(), "rule__ECLBlockDefCS__EnterWhenAssignment_9_2");
					put(grammarAccess.getECLBlockDefCSAccess().getLeaveWhenAssignment_10_2(), "rule__ECLBlockDefCS__LeaveWhenAssignment_10_2");
					put(grammarAccess.getECLEventDefCSAccess().getVisibilityAssignment_0(), "rule__ECLEventDefCS__VisibilityAssignment_0");
					put(grammarAccess.getECLEventDefCSAccess().getConditionAssignment_2_1(), "rule__ECLEventDefCS__ConditionAssignment_2_1");
					put(grammarAccess.getECLEventDefCSAccess().getNameAssignment_4(), "rule__ECLEventDefCS__NameAssignment_4");
					put(grammarAccess.getECLEventDefCSAccess().getOwnedTypeAssignment_6(), "rule__ECLEventDefCS__OwnedTypeAssignment_6");
					put(grammarAccess.getECLEventDefCSAccess().getOwnedSpecificationAssignment_8(), "rule__ECLEventDefCS__OwnedSpecificationAssignment_8");
					put(grammarAccess.getECLEventDefCSAccess().getDsaResultNameAssignment_9_0_1(), "rule__ECLEventDefCS__DsaResultNameAssignment_9_0_1");
					put(grammarAccess.getECLEventDefCSAccess().getFutureAssignment_9_1_2(), "rule__ECLEventDefCS__FutureAssignment_9_1_2");
					put(grammarAccess.getECLEventDefCSAccess().getFeedbackAssignment_9_2_1(), "rule__ECLEventDefCS__FeedbackAssignment_9_2_1");
					...
					put(grammarAccess.getECLExpressionAccess().getTypeAssignment_2(), "rule__ECLExpression__TypeAssignment_2");
					put(grammarAccess.getECLExpressionAccess().getParametersAssignment_4(), "rule__ECLExpression__ParametersAssignment_4");
					put(grammarAccess.getECLExpressionAccess().getParametersAssignment_5_1(), "rule__ECLExpression__ParametersAssignment_5_1");
					put(grammarAccess.getECLRelationAccess().getTypeAssignment_2(), "rule__ECLRelation__TypeAssignment_2");
					put(grammarAccess.getECLRelationAccess().getParametersAssignment_4(), "rule__ECLRelation__ParametersAssignment_4");
					put(grammarAccess.getECLRelationAccess().getParametersAssignment_5_1(), "rule__ECLRelation__ParametersAssignment_5_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			...
			typedParser.entryRuleECLDocument();
